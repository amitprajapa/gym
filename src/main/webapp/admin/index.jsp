<%
      String check = (String) session.getAttribute("userlogin");
	System.out.println(check);
       if(check == null){
    	   response.sendRedirect("http://localhost:8080/gym/admin.jsp");
    	   return;
       }
%>
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li><a href="/gym/admin.jsp" onclick="logoutFunction()"><i class="icon-key"></i> <span>Logout</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                       ...
                       <!--  <ul aria-expanded="false">
                            <li><a href="./index.jspw">Home 1</a></li>
